...
export const FEATURES = [
	{
		...
		description:
			"Create groups for roomates, trips,or events to keep expenses organized.",
	},
	{
...
export const STEPS = [
	{
		...
		description:
			"Start a group for your roomates, trip, or event and invite friends.",
	},
	{
		label: "2",
		title: "Add Expenses",
...
export const TESTIMONIALS = [
	{
		quote: "With Splitr, I finally stopped getting confused about who paid for what!",
		name: "Babu Rao",
	...
	{
		quote: "If that I had known about Splitr earlier, I would have had so much less stress during our road trip!",
		name: "Shyam",
